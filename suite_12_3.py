...
# is_frozen = False будет  выполнять тесты, а is_frozen = True - пропускать и выводить
...
testMD = unittest.TestSuite()
testMD.addTest(unittest.TestLoader().loadTestsFromTestCase(runnerTest.RunnerTest))
testMD.addTest(unittest.TestLoader().loadTestsFromTestCase(tournamentTest.TournamentTest))
